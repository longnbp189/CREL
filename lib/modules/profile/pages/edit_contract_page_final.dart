...
class EditContractPageFinal extends StatefulWidget {
  final Contract contract;
  const EditContractPageFinal({Key? key, required this.contract})
      : super(key: key);

  @override
  State<EditContractPageFinal> createState() => _EditContractPageFinalState();
}

class _EditContractPageFinalState extends State<EditContractPageFinal> {
  ...
  void initState() {
    ...
    if (widget.contract.handoverDate != null) {
      handoverDate = widget.contract.handoverDate;
      _handoverDateController.text =
