...
class ChoseBrand extends StatefulWidget {
  final Function(Brand) callback;
  final Brand? brand;
  const ChoseBrand({Key? key, required this.callback, this.brand})
      : super(key: key);

  @override
  State<ChoseBrand> createState() => _ChoseBrandState();
}

class _ChoseBrandState extends State<ChoseBrand> {
  ...
  Widget build(BuildContext context) {
    ...
    return Row(children: [
      Expanded(
          ...
          child: Text(
            "Thương hiệu: ",
            style: TxtStyle.heading4.copyWith(fontSize: 16),
          )),
      Expanded(
          flex: 5,
              ...
              if (state is BrandIdLoaded) {
                return Container(
                    decoration: BoxDecoration(
                        color:
                            widget.brand != null ? AppColor.boderColor : null,
