...
class ChoseBrandContract extends StatefulWidget {
  final Function(Brand) callback;
  final Brand? brand;
  const ChoseBrandContract({Key? key, required this.callback, this.brand})
      : super(key: key);

  @override
  State<ChoseBrandContract> createState() => _ChoseBrandContractState();
}

class _ChoseBrandContractState extends State<ChoseBrandContract> {
