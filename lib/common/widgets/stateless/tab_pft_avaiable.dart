...
class TabPFRAvaiable extends StatefulWidget {
  const TabPFRAvaiable({Key? key}) : super(key: key);

  @override
  State<TabPFRAvaiable> createState() => _TabPFRAvaiableState();
}

class _TabPFRAvaiableState extends State<TabPFRAvaiable> {
          ...
          BlocListener<PropertyForRentBloc, PropertyForRentState>(
            ...
            child: BlocBuilder<PropertyForRentBloc, PropertyForRentState>(
                buildWhen: (previous, current) =>
                    previous != current && current is PropertyForRentLoaded,
